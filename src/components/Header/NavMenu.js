...
export default function NavBar() {
    ...
    function handleLogout() {
        localStorage.removeItem('userData'); // clear the user's login details from local storage
        setUser(null); // reset the authentication context
      }
    ...
    return (
        <nav className="w-full bg-purple-500 shadow">
            <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
                <div>
                    <div className="flex items-center justify-between py-3 md:py-5 md:block">
                        <a href="javascript:void(0)">
                            <h2 className="text-2xl font-bold text-white">Codyics</h2>
                        </a>
                ...
                {
                    !user?.username ? (<div className="hidden space-x-2 md:inline-block">
                    <Link
                        href="/login"
