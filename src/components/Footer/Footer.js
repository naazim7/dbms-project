  ...
  <div className="container mx-auto px-4">
    <div className="flex flex-wrap text-left lg:text-left">
      <div className="w-full lg:w-6/12 px-4">
        <h4 className="text-xl fonat-semibold text-blueGray-700">Ask,share,learn with</h4>
    ...
    <div className="flex flex-wrap items-center md:justify-between justify-center">
      <div className="w-full md:w-4/12 px-4 mx-auto text-center">
        <div className="text-sm text-blueGray-500 font-semibold py-1">
          Copyright © <span id="get-current-year">2023</span><a href="https://www.creative-tim.com/product/notus-js" className="text-blueGray-500 hover:text-gray-800" target="_blank"> QnA Community ,</a>
          <a href="https://github.com/naazim7/dbms-project" className="text-blueGray-500 hover:text-blueGray-800">Team UnSolved</a>.
        </div>
      </div>
    </div>
  </div>
